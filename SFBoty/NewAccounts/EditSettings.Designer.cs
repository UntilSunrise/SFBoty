namespace SFBoty.NewAccounts {
	partial class EditSettings {
		...
		private void InitializeComponent() {
			...
			this.Benachrichtigungen = new System.Windows.Forms.TabPage();
			this.mailSettings1 = new SFBoty.Controls.MailSettings();
			...
			this.Benachrichtigungen.SuspendLayout();
			this.SuspendLayout();
			// 
			// btnSave
			// 
			...
			this.btnSave.Location = new System.Drawing.Point(541, 431);
			...
			this.btnCancel.Location = new System.Drawing.Point(460, 431);
			...
			this.tabControl1.Controls.Add(this.Benachrichtigungen);
			...
			// allgemeineSettings1
			// 
			this.allgemeineSettings1.Location = new System.Drawing.Point(8, -1);
			this.allgemeineSettings1.Name = "allgemeineSettings1";
			this.allgemeineSettings1.Size = new System.Drawing.Size(309, 400);
			...
			// Benachrichtigungen
			// 
			this.Benachrichtigungen.Controls.Add(this.mailSettings1);
			this.Benachrichtigungen.Location = new System.Drawing.Point(4, 22);
			this.Benachrichtigungen.Name = "Benachrichtigungen";
			this.Benachrichtigungen.Size = new System.Drawing.Size(634, 399);
			this.Benachrichtigungen.TabIndex = 5;
			this.Benachrichtigungen.Text = "Benachrichtigungen";
			this.Benachrichtigungen.UseVisualStyleBackColor = true;
			// 
			// mailSettings1
			// 
			this.mailSettings1.Location = new System.Drawing.Point(8, 3);
			this.mailSettings1.Name = "mailSettings1";
			this.mailSettings1.Size = new System.Drawing.Size(391, 175);
			...
			this.Benachrichtigungen.ResumeLayout(false);
		...
		private System.Windows.Forms.TabPage Benachrichtigungen;
		private Controls.MailSettings mailSettings1;
	}
}